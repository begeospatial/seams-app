...
_component_func = components.declare_component(
    "frame_zoom", path="./seams_app/components/frame_zoom/frontend"
)


def frame_zoom(source: str | Path | np.ndarray | object,
    ...
    st.write(component_value) # (442,380)
    st.session_state['center'] = component_value
